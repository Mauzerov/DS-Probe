...
```python
# Your code here
sns.scatterplot(df_estate, x="n_convenience", y="price_twd_msq")
```
...
```python
# Your code here
sns.scatterplot(df_estate, x="house_age_years", y="price_twd_msq")
```
...
```python
# Your code here
sns.scatterplot(df_estate, x="dist_to_mrt_m", y="price_twd_msq")
```
...
```python
# Your code here
sns.displot(df_estate, x="price_twd_msq", bins=10, col="house_age_cat_str")
```




    <seaborn.axisgrid.FacetGrid at 0x7d71399964b0>
...
```python
# Your code here
cols = ['house_age_years', 'dist_to_mrt_m', 'n_convenience', 'price_twd_msq', 'latitude', 'longitude'][:-2]
print(df_estate.groupby('house_age_cat', observed=False)[cols].mean(numeric_only=True), end="\n\n\n")
print(df_estate.groupby('house_age_cat', observed=False)[cols].std(numeric_only=True), end="\n\n\n")
print(df_estate.groupby('house_age_cat', observed=False)[cols].median(numeric_only=True), end="\n\n\n")
```

                   house_age_years  dist_to_mrt_m  n_convenience  price_twd_msq
    house_age_cat                                                              
    [0, 15)               7.951579     921.666944       4.073684      41.766842
    [15, 30)             19.606977    1529.577237       3.527132      32.642636
    [30, 45)             34.662105     803.120971       4.905263      37.654737
    
    
                   house_age_years  dist_to_mrt_m  n_convenience  price_twd_msq
    house_age_cat                                                              
    [0, 15)               4.845373    1041.207852       2.872022      14.164308
    [15, 30)              4.181043    1499.977924       2.692807      11.398217
    [30, 45)              3.373967    1161.775669       3.248809      12.842547
    
    
                   house_age_years  dist_to_mrt_m  n_convenience  price_twd_msq
    house_age_cat                                                              
    [0, 15)                   8.05       391.9145            5.0          42.55
    [15, 30)                 18.00       837.7233            3.0          32.90
    [30, 45)                 34.40       480.6977            5.0          38.30
...
```
    ...
    Date:                Sat, 31 May 2025   Prob (F-statistic):           4.64e-56
    Time:                        16:52:19   Log-Likelihood:                -1542.5
...
<tr>
  <th>Date:</th>             <td>Sat, 31 May 2025</td> <th>  Prob (F-statistic):</th> <td>7.84e-59</td>
</tr>
<tr>
  <th>Time:</th>                 <td>16:52:22</td>     <th>  Log-Likelihood:    </th> <td> -1530.2</td>
</tr>
<tr>
...
<caption>OLS Regression Results</caption>
<tr>
  <th>Dep. Variable:</th>      <td>price_twd_msq</td>  <th>  R-squared:         </th> <td>   0.463</td>
</tr>
<tr>
...
<tr>
  <th>Date:</th>             <td>Sat, 31 May 2025</td> <th>  Prob (F-statistic):</th> <td>3.36e-56</td>
</tr>
<tr>
  <th>Time:</th>                 <td>16:52:22</td>     <th>  Log-Likelihood:    </th> <td> -1539.0</td>
</tr>
<tr>
  <th>No. Observations:</th>      <td>   414</td>      <th>  AIC:               </th> <td>   3084.</td>
</tr>
<tr>
  <th>Df Residuals:</th>          <td>   411</td>      <th>  BIC:               </th> <td>   3096.</td>
</tr>
<tr>
...
<tr>
  <th>Intercept</th>       <td>   46.7030</td> <td>    0.723</td> <td>   64.557</td> <td> 0.000</td> <td>   45.281</td> <td>   48.125</td>
</tr>
<tr>
  <th>dist_to_mrt_m</th>   <td>   -0.0074</td> <td>    0.000</td> <td>  -18.817</td> <td> 0.000</td> <td>   -0.008</td> <td>   -0.007</td>
</tr>
<tr>
  <th>house_age_30_45</th> <td>   -3.1145</td> <td>    1.177</td> <td>   -2.646</td> <td> 0.008</td> <td>   -5.428</td> <td>   -0.801</td>
</tr>
</table>
<table class="simpletable">
<tr>
  <th>Omnibus:</th>       <td>148.494</td> <th>  Durbin-Watson:     </th> <td>   2.146</td> 
</tr>
<tr>
  <th>Prob(Omnibus):</th> <td> 0.000</td>  <th>  Jarque-Bera (JB):  </th> <td>1045.763</td> 
</tr>
<tr>
  <th>Skew:</th>          <td> 1.346</td>  <th>  Prob(JB):          </th> <td>8.23e-228</td>
</tr>
<tr>
  <th>Kurtosis:</th>      <td>10.306</td>  <th>  Cond. No.          </th> <td>4.18e+03</td> 
</tr>
...
```
    ...
    Date:                Sat, 31 May 2025   Prob (F-statistic):           5.61e-62
    Time:                        16:52:23   Log-Likelihood:                -1525.6
...
std_residuals = best_model.get_influence().resid_studentized_internal
...
sm.graphics.influence_plot(best_model, criterion="cooks")
plt.tight_layout()
plt.show()
```
